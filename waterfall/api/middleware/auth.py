...
class InjectContext(base_wsgi.Middleware):
    """Add a 'waterfall.context' to WSGI environ."""
    ...
    def __call__(self, req):
        req.environ['waterfall.context'] = self.context
        return self.application


class WaterfallKeystoneContext(base_wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        req.environ['waterfall.context'] = ctx
        return self.application
