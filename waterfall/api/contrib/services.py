...
authorize = extensions.extension_authorizer('workflow', 'services')
...
class ServiceController(wsgi.Controller):
    ...
    def index(self, req):
        ...
        for svc in services:
            ...
            if detailed:
                ...
                if svc.binary == "waterfall-workflow":
    ...
    def _freeze(self, context, host):
        return self.workflow_api.freeze_host(context, host)

    def _thaw(self, context, host):
        return self.workflow_api.thaw_host(context, host)

    def _failover(self, context, host, backend_id=None):
        return self.workflow_api.failover_host(context, host, backend_id)
    ...
    def update(self, req, id, body):
        ...
        and allows workflow.manager for the specified host to
...
class Services(extensions.ExtensionDescriptor):
    ...
    name = "Services"
    alias = "os-services"
    namespace = "http://docs.openstack.org/workflow/ext/services/api/v2"
