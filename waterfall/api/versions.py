...
from waterfall.api import openstack
from waterfall.api.openstack import api_version_request
from waterfall.api.openstack import wsgi
from waterfall.api.views import versions as views_versions
...
_MEDIA_TYPES = [{
    ...
    "application/json",
    "type":
    "application/vnd.openstack.workflow+json;version=1",
},
    {"base":
     "application/xml",
     "type":
     "application/vnd.openstack.workflow+xml;version=1",
     },
]
