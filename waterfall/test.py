...
from waterfall.common import config  # noqa Need to register global_opts
from waterfall.db import migration
from waterfall.db.sqlalchemy import api as sqla_api
...
from waterfall.tests import fixtures as waterfall_fixtures
from waterfall.tests.unit import conf_fixture
from waterfall.tests.unit import fake_notifier
...
class TestCase(testtools.TestCase):
    ...
    def start_service(self, name, host=None, **kwargs):
        ...
        kwargs.setdefault('binary', 'waterfall-%s' % name)
