...
XMLNS_WORKFLOW_V1 = ('http://docs.openstack.org/api/openstack-block-storage/1.0/'
                   'content')
XMLNS_WORKFLOW_V2 = ('http://docs.openstack.org/api/openstack-block-storage/2.0/'
                   'content')
...
def validate_schema(xml, schema_name):
    ...
    base_path = 'waterfall/api/schemas/v1.1/'
    if schema_name in ('atom', 'atom-link'):
        base_path = 'waterfall/api/schemas/'
    schema_path = os.path.join(utils.waterfalldir(),
