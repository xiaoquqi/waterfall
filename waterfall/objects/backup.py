...
class Backup(base.WaterfallPersistentObject, base.WaterfallObject,
    ...
    # Version 1.4: Add restore_workflow_id
    VERSION = '1.4'
    ...
    fields = {
        ...
        'temp_workflow_id': fields.StringField(nullable=True),
        ...
        'restore_workflow_id': fields.StringField(nullable=True),
    }
...
@base.WaterfallObjectRegistry.register
class BackupList(base.ObjectListBase, base.WaterfallObject):
    VERSION = '1.0'
