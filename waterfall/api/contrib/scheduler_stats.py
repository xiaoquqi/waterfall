...
from waterfall.api.views import scheduler_stats as scheduler_stats_view
from waterfall.scheduler import rpcapi
...
class Scheduler_stats(extensions.ExtensionDescriptor):
    ...
    namespace = "http://docs.openstack.org/workflow/ext/scheduler-stats/api/v1"
