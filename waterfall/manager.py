...
For example, other components that need to deal with workflows in some way,
should do so by calling methods on the WorkflowManager instead of directly
changing fields in the database.  This allows us to keep all of the code
relating to workflows in the same place.
