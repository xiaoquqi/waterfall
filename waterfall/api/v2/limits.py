...
from waterfall.api.views import limits as limits_views
from waterfall.api import xmlutil
from waterfall.i18n import _
from waterfall import quota
from waterfall.wsgi import common as base_wsgi
...
class LimitsController(wsgi.Controller):
    ...
    def index(self, req):
        ...
        rate_limits = req.environ.get("waterfall.limits", [])
...
class RateLimitingMiddleware(base_wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        req.environ["waterfall.limits"] = self._limiter.get_limits(username)
