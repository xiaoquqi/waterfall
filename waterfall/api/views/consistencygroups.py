...
class ViewBuilder(common.ViewBuilder):
    ...
    def detail(self, request, consistencygroup):
        ...
        if consistencygroup.workflow_type_id:
            workflow_types = consistencygroup.workflow_type_id.split(",")
            workflow_types = [type_id for type_id in workflow_types if type_id]
        else:
            workflow_types = []
