...
from waterfall.i18n import _LE, _LI, _LW
...
class ExtensionManager(object):
    ...
    See waterfall/tests/api/extensions/foxinsocks/extension.py for an
...
class ControllerExtension(object):
    """Extend core controllers of waterfall OpenStack API.

    Provide a way to extend existing waterfall OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in waterfall."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        waterfall.policy.enforce(context, act, target)
    return authorize
