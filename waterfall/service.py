...
service_opts = [
    ...
    cfg.StrOpt('osapi_workflow_listen',
               default="0.0.0.0",
...
def setup_profiler(binary, host):
    ...
    if CONF.profiler.enabled:
        _notifier = osprofiler_notifier.create(
            ...
            rpc.TRANSPORT, "waterfall", binary, host)
...
class Service(service.Service):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'waterfall-' part
        ...
        if not topic:
            topic = binary
        if not manager:
            subtopic = topic.rpartition('waterfall-')[2]
